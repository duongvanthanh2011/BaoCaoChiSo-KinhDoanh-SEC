...
from data_processing import expand_source_ids, build_filtering_conditions, transform_dataframe
...
if submitted:
    ...
    with st.spinner("Đang kết nối API và tải dữ liệu (có thể mất vài phút nếu dữ liệu lớn)..."):
        ...
        filtering_conditions = build_filtering_conditions(
            selected_managers, src_ids, type_ids, date_range
        )
        ...
        df = transform_dataframe(df, src_ids, type_ids, account_types_list)
