...
from reports import render_report_1, render_report_2, render_report_3, render_report_4
...
st.title("📊 Tổng hợp & Phân tích Dữ liệu Học viên - CVHT")
